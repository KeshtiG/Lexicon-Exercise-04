...
namespace SkalProj_Datastrukturer_Minne
{
    class Program
    {
        ...
        static void ExamineList()
        {
            ...
            Console.WriteLine("Add or remove an item from the list by writing '+ your item' or '- your item'.");
            ...
            do
            {
                ...
                switch (nav)
                {
                    ...
                    default:
                        Console.WriteLine("Please use only + or - to add or remove items from the list.");
                        break;
                }
